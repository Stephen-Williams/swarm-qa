...
{ 'ADOMAIN': 'abc.com',
  ...
  'CREATIVE_HEIGHT': 50,
  'CREATIVE_NAME': 'Celtra Creative (MRAID 1.0)',
  'CREATIVE_TYPE': '3',
  'CREATIVE_WIDTH': 320,
  ...
  'TAG': '<script src="mraid.js"></script>\r\n'
         ...
         '    <!-- track.creativeLoads                 = raw '
         'http://w.swarmdsp.com/img/t/t.png?jmn_li=[ALLOCATION_ID]&jmn_crid=[CREATIVE_ID]&jmn_au=[NECTAR_TIME] '
         '-->\r\n'
         '    <!-- track.openWebsite[Click to Website] = raw '
         'http://w.swarmdsp.com/img/t/t.png?jmn_clk=1&jmn_li=[ALLOCATION_ID]&jmn_crid=[CREATIVE_ID]&jmn_au=[NECTAR_TIME]-->\r\n'
         '    <img src="data:image/png,celtra" '
         'style="display: none" onerror="\r\n'
         '        (function(img) {\r\n'
         '            var params = '
         "{'clickUrl':'${ADELPHIC_CLICK_NOREDIRECT}','clickEvent':'firstInteraction','externalAdServer':'Adelphic'};\r\n"
         '            '
         '[].slice.apply(img.parentNode.childNodes).forEach(function(n) '
         '{ var decfs = { urldecode: decodeURIComponent, '
         'htmldecode: function(v) { var d = '
         "document.createElement('div'); d.innerHTML = v; "
         'return d.textContent; }, eval: function(v) { return '
         'eval(v); }, raw: function(v) { return v; } }; var '
         'm; if (n.nodeType == 8 &amp;&amp; (m = '
         'n.textContent.match(/^&#92;s+([&#92;w.]+)(&#92;[.+&#92;])?&#92;s+=&#92;s+(&#92;w+)&#92;s+(.*)$/i))) '
         "{ try { params[m[1]+(m[2] || '')] = "
         'decfs[m[3]](m[4].replace(/^&#92;s+|&#92;s+$/g, '
         "'')); } catch (e) {} } });\r\n"
         '            var req = '
         "document.createElement('script');\r\n"
         '            req.id = params.scriptId = '
         "'celtra-script-' + (window.celtraScriptIndex = "
         '(window.celtraScriptIndex||0)+1);\r\n'
         '            params.clientTimestamp = new '
         'Date/1000;\r\n'
         '            params.clientTimeZoneOffsetInMinutes = '
         'new Date().getTimezoneOffset();\r\n'
         '            var src = (window.location.protocol == '
         "'https:' ? 'https' : 'http') + "
         "'://ads.foobar.com/69ea19ba/mraid-ad.js?';\r\n"
         '            for (var k in params) {\r\n'
         "                src += '&amp;' + "
         ...
         '            }\r\n'
         '            req.src = src;\r\n'
         '            img.parentNode.insertBefore(req, '
         'img.nextSibling);\r\n'
         '        })(this);\r\n'
         '    "/>\r\n'
         '</div>'
